import { Component, createSignal, JSX, onMount, splitProps } from "solid-js";
...
export interface CheckboxProps
    ...
    slotProps?: {
        ...
        checkbox?: JSX.HTMLAttributes<HTMLSpanElement>;
    };
    /**
     * 是否选中（受控）
     */
...
export const Checkbox: Component<CheckboxProps> = (props) => {
    ...
    onMount(() => {
        if (inputRef && local.indeterminate) {
    ...
    const checkboxSlotProps = () => local.slotProps?.checkbox ?? {};
    ...
    return (
        ...
        >
            <input
                ...
                {...others}
            />
            <span data-checkbox {...checkboxSlotProps()} />
