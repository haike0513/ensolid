...
12. [注意事项](#注意事项)
13. [检查清单](#检查清单)
14. [实际移植案例](#实际移植案例radix-ui-primitives)
15. [常见错误和解决方案](#常见错误和解决方案)
16. [调试技巧](#调试技巧)
17. [AI 工作流程规范](#ai-工作流程规范)
18. [参考资料](#参考资料)
...
- **文档生成规范**：除非用户特别提出，否则 AI 不应为每次代码更改生成单独的总结性文档（如 `SUMMARY.md`、`UPDATE_LOG.md` 或类似的记录文件）。AI 应专注于代码实现，并在对话中直接提供必要的说明。
