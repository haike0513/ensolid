...
export const ChartsPage: Component = () => {
  ...
  return (
    <div class="container mx-auto px-4 py-12">
      <h1 class="text-4xl font-bold tracking-tight mb-8">Charts Gallery</h1>

      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {/* Bar Chart */}
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
          <h2 class="text-2xl font-semibold mb-6 self-start">Bar Chart</h2>
        ...
        {/* Line Chart */}
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
          <h2 class="text-2xl font-semibold mb-6 self-start">Line Chart</h2>
          <div class="flex justify-center overflow-x-auto w-full">
            <svg
              width={width}
              height={height}
        ...
        {/* Area Chart */}
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
          <h2 class="text-2xl font-semibold mb-6 self-start">Area Chart</h2>
          <div class="flex justify-center overflow-x-auto w-full">
            <svg
              width={width}
              height={height}
        ...
        {/* Pie Chart */}
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
          <h2 class="text-2xl font-semibold mb-6 self-start">Pie Chart</h2>
          <div class="flex justify-center overflow-x-auto w-full">
            <svg
              width={width}
              height={height}
